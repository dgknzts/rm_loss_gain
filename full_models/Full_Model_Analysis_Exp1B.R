# Full Factorial Model Analysis - Experiment 1B
...
# Primary results
write.csv(summary(rm_contrast), "full_models/analysis_results/Exp1B_primary_RM_contrast.csv", row.names = FALSE)

# Complex interaction results
write.csv(summary(rm_spacing_width_contrasts), "full_models/analysis_results/Exp1B_RM_by_spacing_width.csv", row.names = FALSE)
write.csv(summary(rm_num_width_contrasts), "full_models/analysis_results/Exp1B_RM_by_num_width.csv", row.names = FALSE)
