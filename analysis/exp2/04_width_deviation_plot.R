# Width Deviation Plot - Experiment 2
...
contrast_results <- read.csv("outputs/exp2/tables/width_deviation_rm_contrasts.csv")
...
# Save plot
ggsave("outputs/exp2/figures/width_deviation.png", p,
       width = 7, height = 4, dpi = 300, bg = "white")
ggsave("outputs/exp2/figures/width_deviation.svg", p,
