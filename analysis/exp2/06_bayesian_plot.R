# Bayesian Posterior Density Plot - Experiment 2
...
# Save plot
ggsave("outputs/exp2/figures/bayesian_width_deviation.png", p,
       width = 6, height = 4, dpi = 300, bg = "white")
ggsave("outputs/exp2/figures/bayesian_width_deviation.svg", p,
