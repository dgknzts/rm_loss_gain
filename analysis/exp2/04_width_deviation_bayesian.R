# Bayesian One-Sample T-Test Analysis - Exp2
...
# Save results
if (!dir.exists('outputs/exp2/tables')) {
  dir.create('outputs/exp2/tables', recursive = TRUE)
}

save(bayesian_results, file = "outputs/exp2/tables/bayesian_analysis_results.RData")

# Print results
cat('Bayesian One-Sample T-Tests Results (Exp2):\n\n')
cat('RM Condition:\n')
