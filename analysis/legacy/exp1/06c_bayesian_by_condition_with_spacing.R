# Bayesian One-Sample T-Tests by Width x Set Size x Spacing x RM Type - Exp1
...
ggsave("outputs/exp1/figures/bayesian_heatmap_by_condition_with_spacing.png",
       heatmap_plot, width = 8, height = 8, dpi = 300, bg = "white")

ggsave("outputs/exp1/figures/bayesian_forest_by_condition_with_spacing.png",
...
write_csv(results_export, "outputs/exp1/tables/bayesian_by_condition_with_spacing_results.csv")

cat("Exp1 Bayesian analysis by condition (with spacing) complete.\n")
cat("Total conditions tested: 54 (3 widths x 3 setsizes x 3 spacings x 2 RM types)\n")
cat("Saved: outputs/exp1/figures/bayesian_heatmap_by_condition_with_spacing.png\n")
cat("Saved: outputs/exp1/figures/bayesian_forest_by_condition_with_spacing.png\n")
cat("Saved: outputs/exp1/tables/bayesian_by_condition_with_spacing_results.csv\n")
