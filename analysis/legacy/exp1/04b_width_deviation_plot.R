# Width Deviation Plot with Significance Stars - Exp1
...
ggsave("outputs/exp1/figures/width_deviation_by_width.png",
       width_plot, width = 9, height = 5, dpi = 300, bg = "white")

cat("Saved: outputs/exp1/figures/width_deviation_by_width.png\n")
cat("Saved: outputs/exp1/figures/width_deviation_by_width.pdf\n")
