# Width-Spacing Correlation Analysis - Participant Level Only
# Examines relationship between participant-level width and spacing deviation means
...
analysis_data <- df %>%
  ...
  drop_na(width_deviation, spacing_deviation)

cat(sprintf("Correlation analysis: %d trials from %d participants\n",
...
participant_means_overall <- analysis_data %>%
  ...
  summarise(
    mean_width_dev = mean(width_deviation, na.rm = TRUE),
...
plot1 <- ggplot(participant_means_overall, aes(x = mean_width_dev, y = mean_spacing_dev, color = rm_type)) +
  ...
  labs(
    title = "Width-Spacing Correlation: Overall Participant Means",
    subtitle = "Each point = one participant's mean across all conditions",
    x = "Mean Width Deviation (°)",
...
ggsave("outputs/exp1/figures/width_spacing_correlation_participant_overall.png",
       plot1, width = 7, height = 6, dpi = 300, bg = "white")
cat("Saved: width_spacing_correlation_participant_overall.png\n")
...
corr_setsize <- participant_means_setsize %>%
  ...
  group_modify(~{
    stats <- calc_corr_stats(.x, "mean_width_dev", "mean_spacing_dev")
    tibble(
...
plot2 <- ggplot(participant_means_setsize, aes(x = mean_width_dev, y = mean_spacing_dev, color = rm_type)) +
  ...
  scale_color_manual(values = rm_colors, name = NULL) +
  labs(
    title = "Width-Spacing Correlation by Set Size (Participant Means)",
    x = "Mean Width Deviation (°)",
    y = "Mean Spacing Deviation (°)"
  ) +
  theme_scientific(base_size = 12, base_family = "Arial") +
...
ggsave("outputs/exp1/figures/width_spacing_correlation_participant_by_setsize.png",
       plot2, width = 11, height = 4, dpi = 300, bg = "white")
cat("Saved: width_spacing_correlation_participant_by_setsize.png\n")
...
plot3 <- ggplot(participant_means_width, aes(x = mean_width_dev, y = mean_spacing_dev, color = rm_type)) +
  geom_point(size = 2.5, alpha = 0.7) +
  geom_smooth(method = "lm", se = TRUE, linewidth = 1) +
  geom_text(
  ...
  scale_color_manual(values = rm_colors, name = NULL) +
  labs(
    title = "Width-Spacing Correlation by True Width (Participant Means)",
    x = "Mean Width Deviation (°)",
    y = "Mean Spacing Deviation (°)"
  ) +
  theme_scientific(base_size = 12, base_family = "Arial") +
...
ggsave("outputs/exp1/figures/width_spacing_correlation_participant_by_width.png",
       plot3, width = 11, height = 4, dpi = 300, bg = "white")
cat("Saved: width_spacing_correlation_participant_by_width.png\n")
...
plot4 <- ggplot(participant_means_spacing, aes(x = mean_width_dev, y = mean_spacing_dev, color = rm_type)) +
  geom_point(size = 2.5, alpha = 0.7) +
  geom_smooth(method = "lm", se = TRUE, linewidth = 1) +
  geom_text(
  ...
  scale_color_manual(values = rm_colors, name = NULL) +
  labs(
    title = "Width-Spacing Correlation by Spacing Category (Participant Means)",
    x = "Mean Width Deviation (°)",
    y = "Mean Spacing Deviation (°)"
  ) +
  theme_scientific(base_size = 12, base_family = "Arial") +
...
ggsave("outputs/exp1/figures/width_spacing_correlation_participant_by_spacing.png",
       plot4, width = 11, height = 4, dpi = 300, bg = "white")
cat("Saved: width_spacing_correlation_participant_by_spacing.png\n")
...
plot5 <- ggplot(participant_means_width_setsize,
                aes(x = mean_width_dev, y = mean_spacing_dev, color = rm_type)) +
  ...
  scale_color_manual(values = rm_colors, name = NULL) +
  labs(
    title = "Width-Spacing Correlation by True Width × Set Size",
    x = "Mean Width Deviation (°)",
    y = "Mean Spacing Deviation (°)"
  ) +
...
ggsave("outputs/exp1/figures/width_spacing_correlation_participant_by_width_setsize.png",
       plot5, width = 11, height = 9, dpi = 300, bg = "white")
cat("Saved: width_spacing_correlation_participant_by_width_setsize.png\n")
...
plot6 <- ggplot(participant_means_width_spacing,
  ...
  scale_color_manual(values = rm_colors, name = NULL) +
  labs(
    title = "Width-Spacing Correlation by True Width × Spacing Category",
    x = "Mean Width Deviation (°)",
    y = "Mean Spacing Deviation (°)"
  ) +
  theme_scientific(base_size = 11, base_family = "Arial") +
...
ggsave("outputs/exp1/figures/width_spacing_correlation_participant_by_width_spacing.png",
       plot6, width = 11, height = 9, dpi = 300, bg = "white")
cat("Saved: width_spacing_correlation_participant_by_width_spacing.png\n")
...
plot7 <- ggplot(participant_means_spacing_setsize,
  ...
  scale_color_manual(values = rm_colors, name = NULL) +
  labs(
    title = "Width-Spacing Correlation by Spacing Category × Set Size",
    x = "Mean Width Deviation (°)",
    y = "Mean Spacing Deviation (°)"
  ) +
  theme_scientific(base_size = 11, base_family = "Arial") +
...
ggsave("outputs/exp1/figures/width_spacing_correlation_participant_by_spacing_setsize.png",
       plot7, width = 11, height = 9, dpi = 300, bg = "white")
cat("Saved: width_spacing_correlation_participant_by_spacing_setsize.png\n")
