# Relative Width Density Deviation by Set Size (Collapsed Across Widths)
...
write.csv(as.data.frame(summary(emm_setsize)),
          'outputs/exp1/tables/relative_width_density_deviation_emmeans_by_setsize.csv',
          row.names = FALSE)

contrast_summary <- summary(setsize_contrasts, infer = TRUE)
write.csv(as.data.frame(contrast_summary),
          'outputs/exp1/tables/relative_width_density_deviation_rm_contrasts_by_setsize.csv',
          row.names = FALSE)
...
density_plot <- plot_data %>%
  ...
  labs(title = "Relative Width Density Deviation by Set Size",
       subtitle = "Collapsed across all true widths, normalized by actual density") +
...
ggsave("outputs/exp1/figures/relative_width_density_deviation_by_setsize.png",
       density_plot, width = 7, height = 5, dpi = 300, bg = "white")

ggsave("outputs/exp1/figures/relative_width_density_deviation_by_setsize.pdf",
       density_plot, width = 7, height = 5, bg = "white")

cat("\nSaved: outputs/exp1/figures/relative_width_density_deviation_by_setsize.png\n")
