# Width Density Deviation by True Width (Collapsed Across Set Sizes)
...
write.csv(as.data.frame(summary(emm_width)),
          'outputs/exp1/tables/width_density_deviation_emmeans_by_width.csv',
          row.names = FALSE)

contrast_summary <- summary(width_contrasts, infer = TRUE)
write.csv(as.data.frame(contrast_summary),
          'outputs/exp1/tables/width_density_deviation_rm_contrasts_by_width.csv',
          row.names = FALSE)
...
density_plot <- plot_data %>%
  ...
  labs(title = "Width Density Deviation by True Width",
       subtitle = "Collapsed across all set sizes") +
...
ggsave("outputs/exp1/figures/width_density_deviation_by_width.png",
       density_plot, width = 7, height = 5, dpi = 300, bg = "white")

ggsave("outputs/exp1/figures/width_density_deviation_by_width.pdf",
       density_plot, width = 7, height = 5, bg = "white")

cat("\nSaved: outputs/exp1/figures/width_density_deviation_by_width.png\n")
