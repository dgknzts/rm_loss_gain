# Comprehensive Deviation Analysis Visualization
# Four-panel publication-ready figure
...
analysis_data <- df %>%
  ...
  drop_na(spacing_deviation, width_deviation)

# =============================================================================
# PANEL A: SPACING DEVIATION ANALYSIS
# =============================================================================

# Calculate participant means for spacing deviation
...
# Add significance stars for spacing
...
# Panel A: Spacing deviation plot
panel_a <- plot_data_spacing %>%
...
# =============================================================================
# PANEL B: WIDTH DEVIATION ANALYSIS  
# =============================================================================
...
# =============================================================================
# PANEL C: BAYESIAN DENSITY ANALYSIS
# =============================================================================
...
panel_c <- ggplot(bayesian_plot_data, aes(x = delta)) +
  ...
  annotate(
    ...
    label = paste0("BF₀₁ = ", sprintf("%.3f", bayesian_results$bf_01_rm)),
    color = rm_colors["RM"],
    fontface = "bold",
    size = 4,
    hjust = 0,
...
# =============================================================================
# PANEL D: ROBUSTNESS ANALYSIS
# =============================================================================

rob <- bayesian_results$robustness

# Panel D1: RM robustness
panel_d1 <- ggplot(rob$rm_data, aes(x = prior_scale, y = bf01)) +
...
panel_d2 <- ggplot(norm_data_log, aes(x = prior_scale, y = log_bf01)) +
...
# Create 4-panel comprehensive figure
final_plot <- panel_a / panel_b / panel_c / (panel_d1 | panel_d2)
